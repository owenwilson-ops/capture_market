      ...
      <div className="hero-header">
        <div style={{ maxWidth: '440px', margin: '0 auto' }}>
          ...
          {school && school.id !== 'undecided' && (
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', background: `color-mix(in srgb, ${school.primaryColor} 10%, rgba(255,255,255,0.04))`, border: `1px solid color-mix(in srgb, ${school.primaryColor} 30%, transparent)`, borderRadius: '20px', padding: '7px 16px 7px 10px' }}>
              <div style={{ width: '9px', height: '9px', borderRadius: '50%', background: school.primaryColor, boxShadow: `0 0 10px ${school.primaryColor}` }} />
              <div>
                <div style={{ fontSize: '13px', color: 'rgba(240,234,248,0.85)', fontWeight: 600, lineHeight: 1.1 }}>
                  {school.name}
                </div>
                {school.mascot && (
                  <div style={{ fontFamily: "'Space Mono', monospace", fontSize: '8px', letterSpacing: '1.5px', textTransform: 'uppercase', color: school.primaryColor, marginTop: '2px' }}>
